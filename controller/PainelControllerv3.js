...
$(document).off("change", ".SelecioneMes");
$(document).on("change", ".SelecioneMes", function() {
    Busca_PainelSelecionado($(this).attr('Cod'));
});

//Botão para altera faturamento
$(document).off("change", ".SelecioneMesGrupo");
$(document).on("change", ".SelecioneMesGrupo", function() {
   Busca_PainelSelecionadoGrupo();
});
/*=======================================================================================
*
*
...
function BuscaPainel() {
	...
	$.post('../model/Painel.php', {
        ...
        $('.TicketMedio').html(data['TicketMedio']);
