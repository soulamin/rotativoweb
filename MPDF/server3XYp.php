...
&autodeinfrac=AUTODEINFRACAO
            ...
            params.put("idreboquista",Global.Str_idreboquista);
            params.put("countergrv",Global.Str_countergrv);
            params.put("idempresa",Global.Str_idempresa);
            params.put("idpatio",Global.Str_idpatio);
            params.put("placaveiculo",edit_placaveiculo.getText().toString());
            params.put("chassiveiculo",edit_chassiveiculo.getText().toString());
            params.put("corveiculo",Global.Str_corveiculo);
            params.put("marcaveiculo",edit_marcaveiculo.getText().toString());
            params.put("tipotransporte",Global.Str_tipotransporte);
            params.put("idfiscalizador",Global.Str_idfiscalizador);
            params.put("motivoapreensao",Global.Str_motivoapreensao);
            params.put("text_endOp",Str_endOp);
            params.put("idplacareboque",Global.Str_idplacareboque);
            params.put("fcar",Global.Str_fcar);
            params.put("fren",Global.Str_fren);
            params.put("fcnh",Global.Str_fcnh);
            params.put("flac",Global.Str_flac);
            params.put("status_grv",Global.Str_status_grv);
            params.put("horaop",text_hr.getText().toString());
            params.put("dataop",text_dt.getText().toString());
            params.put("nomeagent",edit_nagente.getText().toString());
            params.put("matricuagent",edit_magente.getText().toString());
            params.put("comchave",Global.Str_chaveveiculo);
            params.put("imei",text_imei_number.getText().toString());
            params.put("listinfracoes",Global.Str_LIF);
            params.put("listaequipa",Global.Str_LEQ);
            params.put("listalacre",Global.Str_LLC);
            params.put("listafotos",Global.Str_fotos);
            params.put("idusuario",Global.Str_idusuario);
            params.put("autodeinfrac",edit_ainfracao.getText().toString());
            params.put("lati_op",String.valueOf(sLati_tmp));
            params.put("long_op",String.valueOf(sLong_tmp));
...
$Grv                 = $_POST['idreboquista'].'/'.$_POST['countergrv'];
$CounterGrv          = $_POST['countergrv'];
$IdPatio             = $_POST['idpatio'];
$DataRemocao         = PdBd($_POST['dataop']);
$HoraRemocao         = $_POST['horaop'].':00';
$Motivo              = $_POST['motivoapreensao'];
$Reboque             = $_POST['idplacareboque'];
$Reboquista          = $_POST['idreboquista'];
$SemPlaca            = 'N';
$Datazero            ='0000-00-00';
$Horazero            ='00:00:00';
$TipoAgente          = $_POST['idfiscalizador']+1;
$MatAgente           = $_POST['matricuagent'];
$NomeAgente          = strtoupper($_POST['nomeagent']);
$Chassi              = $_POST['chassiveiculo'];
$Renavam             = '';
$UsouReboque         = 'N';
$Placa               = $_POST['placaveiculo'];
$TipoVeiculo         = $_POST['tipotransporte'];
$Cor                 = $_POST['corveiculo'];
$MarcaModelo         = strtoupper($_POST['marcaveiculo']);
$Cep                 = '';
$Endereco            = $_POST['endop'];
$Numero              = '';
$Compl               = '';
$Bairro              = '';
$Cidade              = '';
...
$Email              = '';
$DocNoVeiculo       = 'N';
$ChaveVeiculo       = strtoupper($_POST['comchave']);
$NumeroChave        = '';
$InfAdic            = '';
$Assinatura         = 'S';
$Estado             = 'P';
$EstadoEquip        = 6;
$lacre              = $_POST['listalacre'];
$infracao           = $_POST['listinfracoes'];
$Numinfracao        = $_POST['autodeinfrac'];
$StatusAtivo         = 1;
$Equipamento        = $_POST['listaequipa'];
...
$Lati_op = $_POST['lati_op'];
$Long_op = $_POST['long_op'];


// $post_in = $pdo->prepare('INSERT INTO logx (datapost) VALUES (:datapost)');
 //  $pstx->bindParam(':datapost', $_POST);
