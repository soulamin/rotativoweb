...
class Admin extends CI_Controller
{
    ...
    public function getQr($id = '') {
        //$id = $this->input->get('studentId', TRUE);
        ...
        $codeContents = json_encode($student);
    ...
    function movimentacoes() {
        if ($this->session->userdata('admin_login') != 1)
            redirect(base_url(), 'refresh');
        $page_data['page_name']  = 'movimentacoes';
        $page_data['page_title'] = "Movimentações";
        $this->db->order_by('dataHora', 'desc');
        $page_data['movimentacoes'] = $this->db->get('movimentacoes')->result_array();
        $this->load->view('backend/index', $page_data);
    }
