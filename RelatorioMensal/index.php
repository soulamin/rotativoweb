...
$stValor = $pdo->prepare( 'SELECT SUM(VALOR) - (VALOR*0.2)  AS VALORTOTAL  FROM localfiscal L ,ticket T ,usuarios U ,localidade D WHERE T.ID_LOCALFISCAL=L.IDLOCALFISCAL 
...
$stD = $pdo->prepare( 'SELECT SUM(VALOR) - (VALOR*0.2) AS VALORTOTAL  FROM localfiscal L ,ticket T ,usuarios U ,localidade D WHERE T.ID_LOCALFISCAL=L.IDLOCALFISCAL 
