            ...
            <div class="col-md-12">
                ...
                <div class="card card-dark" style="min-height:900px ">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row ">
                            <div class="col-xs-6 col-md-12 text-sm text-muted">Ambiente Seguro <i class="fa fa-lock text-gray"></i></div>
                            <div class="row ">
                                <label class="text-sm text-red">*As Informações contidas abaixo não são guardadas no banco de dados.</label>
                                <div class="col-md-12 text-right col-xs-6">
                                    <label id="Saldo" class="btn btn-outline-danger"></label></div>
